...
def generate_launch_description():
    ...
    package_name_description = mycobot_description_pkg
    package_name_gazebo = package_name_description

    default_robot_name = robot_model
    gazebo_launch_file_path = "launch"
    gazebo_models_path = "models"
    rviz_config_file_path = "rviz/mycobot_320pi_view_description.rviz"
    ...
    default_rviz_config_path = os.path.join(
        pkg_share_description, rviz_config_file_path
    )
