...
def generate_launch_description():
    ...
    urdf_filename = "mycobot_320_pi_2022.urdf"
    rviz_config_filename = "mycobot_320pi_view_description.rviz"
    ...
    # default_value = os.path.join(pkg_share, "urdf/mycobot_320_pi_2022/mycobot_320_pi_2022.urdf")
