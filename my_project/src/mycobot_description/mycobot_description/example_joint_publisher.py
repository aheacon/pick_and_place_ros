...
class ExampleJointTrajectoryPublisherPy(Node):
    ...
    def __init__(self):
        ...
        self.arm_pose_publisher = self.create_publisher(
            JointTrajectory, "/arm_controller/joint_trajectory", 1
        )
        # self.gripper_pose_publisher = self.create_publisher(
        #     JointTrajectory, "/grip_controller/joint_trajectory", 1
        # )
    ...
    def timer_callback(self):
        ...
        point_arm.time_from_start = Duration(
        ...
        point_gripper.time_from_start = Duration(
            sec=int(self.duration_sec), nanosec=int(self.duration_nanosec)
        )
