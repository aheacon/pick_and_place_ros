...
def generate_launch_description():
    ...
    pkg_share_moveit_config = FindPackageShare(package=package_name_moveit_config).find(
    ...
    joint_limits_file_path = os.path.join(
        pkg_share_moveit_config, joint_limits_file_path
    )
    ...
    initial_positions_file_path = os.path.join(
        pkg_share_moveit_config, initial_positions_file_path
    )
